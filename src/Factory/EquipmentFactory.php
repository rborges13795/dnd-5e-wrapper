...
class EquipmentFactory
{
    ...
    public function create(array $data): Equipment
    {
        ...
        if (array_key_exists('armor_category', $data)) {
            $equipment->setArmorCategory($data['armor_category'])
        ...
        if (array_key_exists('weapon_category', $data)) {
            $equipment->setWeaponCategory($data['weapon_category'])
        ...
        if (array_key_exists('tool_category', $data)) {
            $equipment->setToolCategory($data['tool_category']);
        }
